...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            // Calculer les valeurs karma avec la méthode unifiée
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: '⚖️ Karma Total', value: `${karmaTotal}`, inline: true },
                    { name: '💬 Messages', value: `${userStats.messageCount}`, inline: true },
